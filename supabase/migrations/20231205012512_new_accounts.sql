...
CREATE TYPE "public"."ccf_plaid_transaction" AS (
	"id" "text",
	"item_id" "text",
	"name" "text",
	"amount" numeric,
...
ALTER TYPE "public"."ccf_plaid_transaction" OWNER TO "postgres";
...
CREATE TYPE "public"."plaid_account_type" AS ENUM (
    'personal',
    'business',
    'waa'
);

ALTER TYPE "public"."plaid_account_type" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."creative_cash_flow_results" (
    ...
    "total_waa" numeric(12,2) DEFAULT NULL::numeric,
...
CREATE OR REPLACE FUNCTION "public"."create_debt_snowball_record"("user_id" "uuid", "name" "text", "debts" "public"."debt_snowball_debt"[], "inputs" "public"."debt_snowball_inputs_data", "results" "public"."debt_snowball_results_data") RETURNS TABLE("id" "uuid", "created_at" timestamp with time zone)
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  new_id uuid;
...
CREATE OR REPLACE FUNCTION "public"."get_ccf_transactions_by_user_id"("user_id" "uuid") RETURNS TABLE("personal" "public"."ccf_plaid_transaction"[], "business" "public"."ccf_plaid_transaction"[])
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $_$
DECLARE
...
ALTER FUNCTION "public"."get_ccf_transactions_by_user_id"("user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_waa_account_id"() RETURNS TABLE("account_id" "text", "item_id" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_waa_account_id"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."verify_update_plaid_accounts"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  duplicate_count INT;
...
ALTER FUNCTION "public"."verify_update_plaid_accounts"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."plaid" (
    ...
    "cursor" "text",
    "new_accounts" boolean DEFAULT false NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."plaid_accounts" (
    ...
    "item_id" "text" NOT NULL,
    "name" "text" NOT NULL,
    "type" "public"."plaid_account_type" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."waa" (
    "id" integer NOT NULL,
    "user_id" "uuid" NOT NULL,
    "date" timestamp with time zone NOT NULL,
    "amount" numeric(12,2) NOT NULL
...
ALTER TABLE "public"."waa" OWNER TO "postgres";

ALTER TABLE "public"."waa" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."waa_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."waa"
    ADD CONSTRAINT "waa_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_waa_user_id" ON "public"."waa" USING "btree" ("user_id");
...
CREATE TRIGGER "on_update_plaid_accounts" BEFORE UPDATE ON "public"."plaid_accounts" FOR EACH ROW EXECUTE FUNCTION "public"."verify_update_plaid_accounts"();
...
ALTER TABLE ONLY "public"."waa"
    ADD CONSTRAINT "waa_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Can delete own waa" ON "public"."waa" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "Can insert new waa" ON "public"."waa" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
ALTER TABLE "public"."waa" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."get_ccf_transactions_by_user_id"("user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_ccf_transactions_by_user_id"("user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_ccf_transactions_by_user_id"("user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_waa_account_id"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_waa_account_id"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_waa_account_id"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."verify_update_plaid_accounts"() TO "anon";
GRANT ALL ON FUNCTION "public"."verify_update_plaid_accounts"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."verify_update_plaid_accounts"() TO "service_role";
...
GRANT ALL ON TABLE "public"."waa" TO "anon";
GRANT ALL ON TABLE "public"."waa" TO "authenticated";
GRANT ALL ON TABLE "public"."waa" TO "service_role";

GRANT ALL ON SEQUENCE "public"."waa_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."waa_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."waa_id_seq" TO "service_role";
