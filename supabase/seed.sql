...
/**
 * creative_cash_flow_notifications table
 */

DROP TABLE IF EXISTS creative_cash_flow_notifications CASCADE;
CREATE TABLE creative_cash_flow_notifications (
  id int PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
  email text NOT NULL,
  enabled boolean NOT NULL DEFAULT true
);

ALTER TABLE public.creative_cash_flow_notifications ENABLE ROW LEVEL SECURITY;

-- Because the user_id is not stored in the notifications table, we need to join the plaid table
-- to make sure the user is an admin

CREATE POLICY "Admin can view plaid creative_cash_flow_notifications data" ON public.creative_cash_flow_notifications
  FOR SELECT
  TO authenticated
  USING (
    EXISTS (
...
CREATE POLICY "Admin can insert plaid creative_cash_flow_notifications" ON public.creative_cash_flow_notifications
  FOR INSERT
  TO authenticated
  WITH CHECK (
    EXISTS (
...
CREATE POLICY "Admin can update plaid creative_cash_flow_notifications data" ON public.creative_cash_flow_notifications
  FOR UPDATE
  TO authenticated
  USING (
    EXISTS (
...
CREATE POLICY "Admin can delete plaid creative_cash_flow_notifications" ON public.creative_cash_flow_notifications
  FOR DELETE
  TO authenticated
  USING (
    EXISTS (
