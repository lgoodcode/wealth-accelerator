...
CREATE POLICY "No access" ON public.insurance_companies
  FOR SELECT USING (false);

--
-- Add once insurance companies and their scripts can be managed by admins
--
...
CREATE TABLE insurance_policy_rows (
  ...
  loan_interest_rate smallint NOT NULL DEFAULT 45, -- divide by 100 -> 4.5%
