          ...
          <div className="accordion" id="accordionRental">
            <div className="accordion-item mb-3">
              <h5 className="accordion-header" id="headingOne">
                ...
                >
                  How do I order?
                  <i className="collapse-close fa fa-plus text-xs pt-1 position-absolute end-0 me-3"></i>
                  <i className="collapse-open fa fa-minus text-xs pt-1 position-absolute end-0 me-3"></i>
                </button>
              </h5>
              <div
                id="collapseOne"
            ...
            <div className="accordion-item mb-3">
              ...
              >
                <div className="accordion-body text-sm opacity-8">
                  ...
                  follow my dreams and inspire other people to follow their dreams, too. We’re not
                  always in the position that we want to be at. We’re constantly growing. We’re
                  constantly making mistakes. We’re constantly trying to express ourselves and
                  actualize our dreams. If you have the opportunity to play this game of life you
                  need to appreciate every moment. A lot of people don’t appreciate the moment until
                  it’s passed.
                </div>
            ...
            <div className="accordion-item mb-3">
              ...
              >
                <div className="accordion-body text-sm opacity-8">
                  ...
                  doesn&#39;t, it actually succeeds - just the fact that I&#39;m willing to fail is
                  an inspiration. People are so scared to lose that they don&#39;t even try. Like,
                  one thing people can&#39;t say is that I&#39;m not trying, and I&#39;m not trying
            ...
            <div className="accordion-item mb-3">
              ...
              >
                <div className="accordion-body text-sm opacity-8">
                  ...
                  won’t do anything. I was taught I could do everything. If everything I did failed
                  - which it doesn&#39;t, it actually succeeds - just the fact that I&#39;m willing
                  to fail is an inspiration. People are so scared to lose that they don&#39;t even
                  try. Like, one thing people can&#39;t say is that I&#39;m not trying, and I&#39;m
            ...
            <div className="accordion-item mb-3">
              ...
              >
                <div className="accordion-body text-sm opacity-8">
                  ...
                  be wrong because you can’t learn anything from a compliment. I always felt like I
                  could do anything. That’s the main thing people are controlled by! Thoughts- their
                  perception of themselves! They&#39;re slowed down by their perception of
                  themselves. If you&#39;re taught you can’t do anything, you won’t do anything. I
