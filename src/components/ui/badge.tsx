...
const badgeVariants = cva(
  'inline-flex select-none items-center border rounded-full px-2 py-1.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
