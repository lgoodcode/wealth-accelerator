...
export const CreativeCashFlowHelpContent = (
  <div className="space-y-6">
    ...
    <div className="space-y-2">
      ...
      <div className="space-y-4">
        <p>
          Without an understanding of Trends, it&apos;s unlikely you will know what they can reveal
          and what you can do to change or improve your results.
        </p>
        <ol className="pl-6 list-decimal space-y-1">
          ...
          <li>
            ...
            internal operations are the other 2 players that enable and empower success. The amount
            of collections will determine how efficient and effective you are at attracting and
            retaining patients, and will determine how effective your internal operations are
            functioning.
          </li>
          <li>
