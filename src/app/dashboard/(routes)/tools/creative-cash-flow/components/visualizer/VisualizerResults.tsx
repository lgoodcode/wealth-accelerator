...
const getCcfValue = (data: VisualizeCcf) => data.collections;
...
export function VisualizerResults({ height, width }: VisualizerResultsProps) {
  ...
  return <Base data={data} width={width} height={height} />;
}
