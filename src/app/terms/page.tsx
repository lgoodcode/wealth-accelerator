  ...
  return (
    <>
      <div className="relative p-12 rounded-t-2xl bg-gradient-to-r from-cyan-900 to-cyan-600">
        ...
        <p className="text-base text-white opacity-80 mb-4">Last modified: Sep 30 2023</p>
      </div>
    </>
  );
};
    ...
    <>
      <div className="md:p-12 p-8">
        ...
        <p className="text-muted-foreground mb-4">
          These terms and conditions outline the rules and regulations for the use of Creative
          Tim&#39;s Website, located here.
        </p>
        <p className="text-muted-foreground mb-4">
          By accessing this website we assume you accept these terms and conditions. Do not continue
          to use Creative Tim if you do not agree to take all of the terms and conditions stated on
          this page.
        </p>
        ...
        <h2 id="privacy-policy" className="text-3xl text-muted-foreground font-bold mb-3">
          Your Privacy
        </h2>
        <p className="text-muted-foreground mb-8">
          Please read{' '}
