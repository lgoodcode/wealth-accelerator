...
const QuickLinks = () => {
  return (
    <div className="w-[280px] min-w-[280px] lg:block hidden">
      <ul className="sticky top-24 p-4 rounded-md bg-white leading-relaxed text-muted-foreground shadow-xl font-medium">
      ...
      <section id="general" className="container pt-36">
        <div className="flex justify-center max-w-full">
          <div className="flex flex-row gap-8">
            <QuickLinks />
            <div className="bg-white shadow-xl max-w-5xl">
              ...
              <div className="px-8 py-12 md:px-12 space-y-12 text-muted-foreground">
                <div className="space-y-4">
                  ...
                  <p>
                    ...
                    not continue to use the ChiroWealth WealthAccelerator app if you do not agree to
