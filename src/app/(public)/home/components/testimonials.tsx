...
export const testimonials: Testimonial[] = [
  {
    ...
    companyUrl: 'https://www.mitchellfamilychiro.com/',
  ...
  },
  {
    ...
    companyUrl: 'https://rogerdsmithdc.com/',
    message:
  ...
  },
  {
    ...
    companyUrl: 'https://uppercervicaltreviso.it/',
    message:
  ...
  },
  {
    ...
    companyUrl: 'https://www.chiropractortorrance.com/',
    message:
  ...
  },
  {
    ...
    companyUrl: 'https://www.byrnechiropractic.com/dr-stephen-byrne/',
    message:
  ...
  },
  {
    ...
    personalImage: '/img/testimonials/david-schwartz.jpg',
    companyImage: '/img/testimonials/david-schwartz-company.jpg',
    companyUrl: 'https://triadhealthcenter.com/dr-dave-schwartz/',
    message:
...
const TesitmonialItem = ({ testimonial }: { testimonial: Testimonial }) => {
  return (
    ...
    >
      <a href={testimonial.companyUrl} className="space-y-4" referrerPolicy="origin" target="_self">
